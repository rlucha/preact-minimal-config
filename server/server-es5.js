...
var serverpush = require('koa-server-push');
...
router.get("/page01", async function (ctx, next) {
  var preloadedState = await (0, _nodeFetch2.default)("http://broadband-api.uswitchinternal.com/providers_all").then(function (res) {
    return res.json();
  });
